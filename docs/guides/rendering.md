...
For the underlying signal primitives, see [Reactivity](/guides/reactivity). For the `.nv` file format, see [Authoring .nv](/guides/authoring-nv).
...
- [Authoring .nv](/guides/authoring-nv) — file format, `$component`, `$script`
- [Reactivity](/guides/reactivity) — `signal`, `derived`, `effect`
- [API Reference](/api/) — full signatures for all built-ins
